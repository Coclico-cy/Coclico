...
namespace Coclico.Services
{
    public sealed class KeyboardShortcut
    {
        ...
        public string ActionType { get; set; } = "FlowChain";
    ...
    {
        private static KeyboardShortcutsService? _instance;
        public static KeyboardShortcutsService Instance => _instance ??= new KeyboardShortcutsService();
