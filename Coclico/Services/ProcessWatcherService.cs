...
namespace Coclico.Services
{
    ...
    {
        private static readonly Lazy<ProcessWatcherService> _lazyInstance = new(() => new ProcessWatcherService());
        public static ProcessWatcherService Instance => _lazyInstance.Value;
