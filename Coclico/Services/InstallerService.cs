...
namespace Coclico.Services
{
    public class InstallerService
    {
        ...
        public List<SoftwareItem> GetAvailableSoftware()
        {
            ...
            {
                Debug.WriteLine($"Erreur chargement JSON : {ex.Message}");
            }
        ...
        private async Task<bool> RunWinget(SoftwareItem software, Action<string>? onOutput, CancellationToken ct)
        {
            ...
            else
            {
                ...
                try { scope = Coclico.Services.SettingsService.Instance.Settings.WingetScope == "user" ? "--scope user" : "--scope machine"; } catch { }
