...
namespace Coclico.Services
{
    ...
    public class SettingsService
    {
        ...
        private readonly System.Threading.SemaphoreSlim _ioLock = new(1, 1);
        ...
        private static AppSettings Sanitize(AppSettings s)
        {
            ...
            if (string.IsNullOrWhiteSpace(s.AccentColor) || !System.Text.RegularExpressions.Regex.IsMatch(s.AccentColor, @"^#[0-9A-Fa-f]{6,8}$"))
        ...
        public void EnableAutostart()
        {
            try
            {
                ...
                var exePath = System.Diagnostics.Process.GetCurrentProcess().MainModule?.FileName
                    ?? System.AppContext.BaseDirectory + "Coclico.exe";
