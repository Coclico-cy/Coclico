...
namespace Coclico.ViewModels
{
    public class DashboardViewModel : INotifyPropertyChanged, IDisposable
    {
        ...
        public string RamUsageText => $"{RamUsedGb:F1} GB / {RamTotalGb:F1} GB";
        ...
        public string DiskUsageText => $"{DiskUsedGb:F1} GB / {DiskTotalGb:F1} GB";
        ...
        private async Task RefreshAllAsync(CancellationToken ct)
        {
            try
            {
                ...
                int apps = InstalledProgramsService.Instance.GetMemoryCacheIconPaths().Count;
